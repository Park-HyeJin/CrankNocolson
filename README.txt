...
The other (FE) is the code for the forward Euler method to solve the reacion-diffusion equation with density-dependent diffusion coefficients.
The test gunplot scripts and data are available in each folder.
